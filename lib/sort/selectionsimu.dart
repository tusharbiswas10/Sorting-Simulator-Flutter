...
class selectionSimulation extends StatefulWidget {
  @override
  _selectionSimulationState createState() => _selectionSimulationState();
}

class _selectionSimulationState extends State<selectionSimulation> {
